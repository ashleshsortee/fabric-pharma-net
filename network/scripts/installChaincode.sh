...
instantiateChaincode 0 'manufacturer' $VERSION 'registration'
echo "Instantiating chaincode on channel using peer0.manufacturer.pharma-network.com.com ..."
instantiateChaincode 0 'manufacturer' $VERSION 'transfer'
echo "Instantiating chaincode on channel using peer0.manufacturer.pharma-network.com.com ..."
instantiateChaincode 0 'manufacturer' $VERSION 'lifecycle'
